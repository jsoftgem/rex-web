(function () {
    ...
    LevelCtrl.$inject = ['$scope', 'DTOptionsBuilder', 'DTColumnBuilder', 'flowModalService', '$compile', 'sessionService', 'commonFactories'];

    function LevelCtrl(s, dto, dtc, fm, c, ss, commonFactories) {
        ...
        function activate() {
            ...
            s.task.level = {};
            s.task.level.getEducationLevels = getEducationLevels;
            ...
            s.deleteConfirm = function () {
                ...
                fm.hide(s.flow.getElementFlowId('levelDeleteModal'), s.flow.getElementFlowId('level_edit_form'), function () {
        ...
        function getEducationLevels() {
            s.task.level.educationLoaded = false;
            commonFactories.educationLevelService.getEducationLevels(function (educationLevels) {
                s.task.level.educationLoaded = true;
                s.task.level.educationLevels = educationLevels;
            }, function () {
                s.task.level.educationLoaded = true;
                s.task.level.educationLevels = [];
            });
        }

        function destroy() {
            s.task.level = undefined;
        }
