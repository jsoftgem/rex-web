(function () {
        ...
        function SchoolYearEditCtrl(s, fm, commonFactories) {
            ...
            function activate() {
                ...
                s.task.schoolYear.getMonthTo = getMonthTo;
            ...
            function getMonth(selected) {
                if (!selected) {
                    s.task.schoolYear.periodMonth = commonFactories.monthService.getMonth(s.task.modelEdit.periodMonth);
                }
                return selected;
            }

            function getMonthTo(selected) {
                if (!selected) {
                    s.task.schoolYear.periodMonthTo = commonFactories.monthService.getMonth(s.task.modelEdit.periodMonthTo);
                }
                return selected;
            }
        }
