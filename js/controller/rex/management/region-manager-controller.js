angular.module("regionManager", ["fluid", "ngResource", "datatables", "ngCookies", "flowServices"])
    .controller('regionManagerCtrl', ["$scope", "DTOptionsBuilder", "DTColumnBuilder", "flowMessageService", "flowModalService", "$compile", "$filter", "$cookies", "userProfile", "imageService", function (s, dto, dtc, ms, fm, c, f, co, up, is) {
    ...
    .controller("regionTaggingCtrl", ["$scope", "DTOptionsBuilder", "DTColumnBuilder", "flowMessageService", "flowModalService", "$compile", "$filter", "$cookies", "userProfile", function (s, dto, dtc, ms, fm, c, f, co, up) {
        s.task.preLoad = function () {
