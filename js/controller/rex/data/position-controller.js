...
angular.module("positionController",["fluid", "ngResource", "datatables", "ngCookies"])
.controller("positionCtrl", ["$scope", "DTOptionsBuilder", "DTColumnBuilder", "flowMessageService", "flowModalService", "$compile", "$filter", "$cookies", function (s, dto, dtc, ms, fm, c, f, co) {
