...
(function ($) {
    ...
    var methods = {init: function (options) {
        options = $.extend({mastaClass: "drawer-main", overlayClass: "drawer-overlay", toggleClass: "drawer-toggle", upperClass: "drawer-overlay-upper", openClass: "drawer-open", closeClass: "drawer-close", responsiveClass: "drawer-responsive"}, options);
        return this.each(function () {
            ...
            $this.append($upper);
            var drawerScroll = new IScroll("." + options.mastaClass, {scrollbars: true, mouseWheel: true, click: true, fadeScrollbars: true});
