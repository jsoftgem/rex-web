 ...
 */
angular.module("flowAppDirectives", ["fluid"])
    .directive("addPages", ["flowHttpProvider", "flowModalService", "$compile", function (f, fm, c) {
        return {
    ...
    .directive("addAllPages", ["flowHttpProvider", function (f) {
    ...
    .directive("fluidMenu", function ($parse, $compile, $timeout, flowHttpProvider, flowFrameService) {
        return {
    ...
    .directive("fluidSubTaskbar", ["flowFrameService", "$timeout", "$compile", function (f, t, c) {
        return {
            restrict: "A",
            link: function (scope, element) {
    ...
    .directive("fluidReportTable", ["$compile", function (c) {
        return {
            scope: {table: "="},
            restrict: "AE",
            replace: true,
    ...
    .directive("fluidReportColumn", ["$compile", function (c) {
        return {
            scope: true,
            link: function (scope, element, attr) {
    ...
    .directive("fluidRenderWidth", [function () {
        return {
            restrict: "A",
    ...
    .directive("flowBarTooltip", ["$timeout", "flowFrameService", "flowHttpProvider", function (t, f, f2) {
        return {
            scope: {task: '=', index: "="},
            restrict: "A",
            link: function (scope, element, attr) {
